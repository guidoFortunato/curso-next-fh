...
export const ProductCard = ({ image, name, price, id, rating }: Props) => {
  ...
  const onRemmoveFromCart = () => {
    removeProductFromCart(id);
    router.refresh();
  };

  return (
    <div className="bg-gray-800 shadow rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-100">
      {/* Product Image */}
      <div className="p-2">
        <Image
          width={500}
